...
import Tarea4_mod.CLASESDATOS.NotaAlumno;
import Tarea4_mod.CLASESDATOS.NotaModulo;
...
/*try (ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream("src/ficheros/NotasAlumnos1.dat"))){
