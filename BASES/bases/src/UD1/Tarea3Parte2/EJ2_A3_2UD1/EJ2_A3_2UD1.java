package UD1.Tarea3Parte2.EJ2_A3_2UD1;
...
public class EJ2_A3_2UD1 {
    ...
    private static void runCode(String[] args) throws IOException {
        ...
        try {
            while (true){
                ...
                if (partes.length == 3){
                    borrar(new File("src\\UD1\\Tarea3Parte2\\EJ2_A3_2UD1\\ALUMNOS\\" + partes[0]));
                    new File("src\\UD1\\Tarea3Parte2\\EJ2_A3_2UD1\\ALUMNOS\\" + partes[0] + "\\" + partes[1] + "-" + partes[2]).mkdirs();
                    bufferedWriter.write("src\\UD1\\Tarea3Parte2\\EJ2_A3_2UD1\\ALUMNOS\\" + partes[0] + "\\" + partes[1] + "-" + partes[2]+" -----> se creo correctamente");
    ...
    private static void borrar(File file) throws IOException {
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("src\\UD1\\Tarea3Parte2\\EJ2_A3_2UD1\\ficherolog.txt",true));
