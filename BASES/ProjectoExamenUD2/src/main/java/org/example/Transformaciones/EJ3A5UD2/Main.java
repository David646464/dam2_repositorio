package org.example.Transformaciones.EJ3A5UD2;
...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            String xmlFile = "src/main/java/org/example/Transformaciones/EJ3A5UD2/Alumnos.xml";
            String xslFile = "src/main/java/org/example/Transformaciones/EJ3A5UD2/Alumnos.xsl";
            String xmlOutputFile = "src/main/java/org/example/Transformaciones/EJ3A5UD2/AlumnosOut.xml";
