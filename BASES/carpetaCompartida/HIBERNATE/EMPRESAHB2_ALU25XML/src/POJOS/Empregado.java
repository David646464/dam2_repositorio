...
public class Empregado implements java.io.Serializable {
    ...
    public String toString() {
        return "Empregado{" + "nss=" + nss + ", nome=" + nome + ", apelido1=" + apelido1 + ", apelido2=" + apelido2 + ", dataNacemento=" + dataNacemento + ", sexo=" + sexo + ", rua=" + rua + ", numeroCalle=" + numeroCalle + ", piso=" + piso + ", cp=" + cp + ", localidade=" + localidade + ", provincia=" + provincia + '}';
    }
