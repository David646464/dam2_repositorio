...
--
-- Host: localhost:3306
-- Generation Time: Feb 18, 2025 at 12:10 PM
...
('11111111A', 'Pedro', 'Perez', 'Chousa', '981111111', 'pedro@gmail.com'),
('111144', 'Kevin', 'Outeir', 'Cons', '986787744', 'kevincinho@hotmail.com'),
('123', 'Martin', 'Cabaleiro', 'Davila', '986858585', 'cabaleiroala@live.com'),
('1234321', 'Cesar', 'Aguin', 'Estevez', '633123123', 'correokk@sapo.pt'),
('1243', 'Manuel', 'Fontán', 'Davila', '644888556', 'fonti@gmail.com'),
('19283746Z', 'Fina', 'Risitas', 'De Los Montes', '612987654', 'fina.risitas@yahoo.es'),
('213', 'Ramón', 'Barcaza', 'Bernal', '688777888', 'barc@bernal.com'),
('22222222B', 'A22na', 'Miranda', 'Lodeiro', '982222222', 'ana@hotmail.com'),
('24713685V', 'Tina', 'Castaña', 'Pilonga', '666234789', 'tina.pilonga@bosque.com'),
('324', 'David', 'López', 'López', '644777111', 'proyectosdam@gmail.com'),
...
('54782134G', 'Antó', 'Cortapelos', 'De León', '699123456', 'antoncorte@gmail.com'),
('57289341D', 'Héctor', 'Calcetín2', 'Perdido', '654789321', 'hector.calcetin@gmail.com'),
...
('76401369S', 'Iyrene', 'Fraga', 'Hernando', '986858789', 'ifh@fraga.com'),
...
('84937261Y', 'Gustavo', 'Bigote', 'Risol', '688789123', 'gustavo.bigote@barber.com'),
('93847162J', 'Arturo', 'Rebanada', 'Del Pan', '655123789', 'a.rebanada@panaderia.es'),
...
--
ALTER TABLE `citasperrucaria`
  MODIFY `codCita` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `razas`
  MODIFY `codRaza` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
