...
(10, '4577', '2021-11-29', 10),
(13, '1111', '2021-11-22', 10),
...
('22222222B', 'Ana', 'Miranda', 'Lodeiro', '982222222', 'ana@hotmail.com'),
...
('44789445T', 'Andrés', 'Aguín', 'López', '611222333', 'spamaqui@gmai.com'),
('48576298D', 'Pepe', 'Patillas', 'Locas', '654987123', 'pepe.patillas@barberia.com'),
('54782134G', 'Antón', 'Cortapelos', 'De León', '699123456', 'antoncorte@gmail.com'),
...
('781231233', 'Jose', 'Dominguez', 'Sánchez', '648988622', 'ventin.cdm@gmail.com'),
...
--
ALTER TABLE `citasperrucaria`
  MODIFY `codCita` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `vacinacions`
  MODIFY `codVacinacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
