...
public class prueba2 {
    public static void main(String[] args)
        ...
        String[] descripciones={"paquetes de papel", "lápices", "bolígrafos",
                "carteras", "mesas"};
        DataOutputStream salida=new DataOutputStream(new FileOutputStream("src\\psp\\pedido.dat"));
        ...
        DataInputStream entrada = new DataInputStream(new
                FileInputStream("src\\psp\\pedido.dat")) ;
        try {
            while (true)
            { //para leer la cadena de caracteres.
                ...
                System.out.println("has pedido "+unidad+" "+descripcion+ " psp " +precio+" Euros.");
